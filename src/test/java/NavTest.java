...
public class NavTest {
    ...
    void adjacent() {
        ...
        goal.getObjects().add("Goal!");
        Object result = grid.findNearest(origin, "Goal!"::equals, 1);
    ...
    void twoAway() {
        ...
        goal.getObjects().add("Goal!");
        Object result = grid.findNearest(origin, "Goal!"::equals, 2);
        Assertions.assertEquals("Goal!", result);
    }
    ...
    void smallRadius() {
        ...
        Object result2 = grid.findNearest(origin, "Goal!"::equals, 2);
        Assertions.assertNotNull(result2);

        Object result3 = grid.findNearest(origin, "Goal!"::equals, 3);
